...
\begin{figure*}
  ...
  \caption{Example mimic FSA simplified from SoPa's and its corresponding WFSAs \citep{schwartz2018sopa}}
  \label{fsa}
\end{figure*}
...
% LocalWords:  centroids CNNs BiLSTM hyperparameters SoPa's WFSAs embeddings
