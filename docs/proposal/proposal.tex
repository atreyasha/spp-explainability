...
\begin{figure*}
  \centering 
  \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=\textwidth]{./images/sopa_computational_graph.png} 
...
\begin{figure*}
  \centering 
  \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=0.7\textwidth]{./images/sample_fsa_sopa.png} 
