...
As mentioned in Section \ref{section:xai-techniques}, we found multiple studies
...
\paragraph{String vs. document score:} Definition \ref{def:string-score}
