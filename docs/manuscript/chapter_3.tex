...
In regards to transparency, \ac{sopa}++ is a hybridized model consisting of \ac{rnn},
...
To obtain some variation in our \ac{sopa}++ models, we decide to use a grid-search
