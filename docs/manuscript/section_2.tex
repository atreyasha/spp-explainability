% Tasks:
% TODO change bibtex entries to equivalent ones but in published venues instead of arxiv
% TODO strucutre literature review for articles that were explored and not useful -> as well as those that were explored and deemed to be useful -> perhaps can make a table of analyses
% TODO add figures where possible for better explanations
% TODO add extra subsection or section for timeline -> perhaps can use gannt chart if this works well
