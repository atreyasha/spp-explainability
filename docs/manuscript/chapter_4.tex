...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.1cm 1.1cm 1.1cm 1.1cm},clip,width=14cm]{pdfs/generated/neurons_regex_1617634929/activating_regex_sample_21.pdf}
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.1cm 1.1cm 1.1cm 1.1cm},clip,width=14cm]{pdfs/generated/neurons_regex_1617634929/activating_regex_sample_27.pdf}
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.1cm 1.1cm 1.1cm 1.1cm},clip,width=14.5cm]{pdfs/generated/neurons_regex_1617634929/activating_regex_sample_32.pdf}
