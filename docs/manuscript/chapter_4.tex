...
\begin{figure}[t!]
  \centering \includegraphics[trim={1.1cm 1.1cm 1.1cm
    1.1cm},clip,width=11cm]{pdfs/generated/neurons_regex_1618067722/activating_regex_sample_19.pdf}
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.1cm 1.1cm 1.1cm 1.1cm},clip,width=14.5cm]{pdfs/generated/neurons_regex_1618067722/activating_regex_sample_25.pdf}
  \caption{Ten sampled regular expressions from the RE lookup layer
...
\begin{figure}[t!]
  \centering
  \includegraphics[trim={1.1cm 1.1cm 1.1cm 1.1cm},clip,width=12.25cm]{pdfs/generated/neurons_regex_1618067722/activating_regex_sample_17.pdf}
  \caption{Ten sampled regular expressions from the RE lookup layer
