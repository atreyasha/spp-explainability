...
\begin{document}
  ...
  \subsection{}
    ...
    \begin{figure}				       
      ...
      \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=10cm]{fsa.png}
  ...
  \subsection{}
    ...
    \begin{figure}				       
			\captionsetup{justification=centering}
      \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=11cm]{sopa.png}
  ...
  \subsection{}
    ...
    \begin{figure}				       
			\captionsetup{justification=centering}
      \includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=10cm]{sopa_upper_diagram/main.pdf}
  ...
  \subsection{}
    ...
    \begin{figure}				       
			\captionsetup{justification=centering}
      \includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=9.5cm]{sopa_upper_diagram_explain/main.pdf}
  ...
  \begin{frame}
    ...
    \begin{figure}				       
			\captionsetup{justification=centering}
      \includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=10cm]{tensorboard_performance.png}
