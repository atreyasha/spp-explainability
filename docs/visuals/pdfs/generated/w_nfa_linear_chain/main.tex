...
\begin{tikzpicture}[thick, every edge/.append style={font=\large},
  ...
  \path[->] (qS_0_2) edge[bend left=50] node[above] {\textbf{great}} (qS_0_3)
  (qS_0_2) edge[bend right=50] node[below] {\textbf{entertaining}} (qS_0_3) {};
  \path[->] (qS_0_3) edge node[above] {\textcolor{blue}{$\pmb{\omega}$}} (qS_0_4) {};
