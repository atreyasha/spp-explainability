...
\begin{tikzpicture}[x=8cm, y=5cm, thick]
  ...
  \foreach \e/\c [count=\y] in {1/90,2/0,3/0}{
    \node [every neuron, minimum size=0.01cm, fill=blue!\c] (wfsa-small-\y)
  ...
  \foreach \t [count=\X] in {[START], 10, day, weather, forecast, [END]}{
    ...
    \foreach \m [count=\x] in {1,h-missing,2}{
      ...
      \ifnum \x=1 
      \node [every neuron/.try, minimum size=0.01cm, fill=blue!\alpha,
    ...
    \foreach \e [count=\y] in {1,2,3}{
      ...
      \let\alpha\pgfmathresult
      \node [every neuron, minimum size=0.01cm, fill=blue!\alpha]
...

  {
    ...
    \foreach \m [count=\y] in {1,2,3,4,v-missing-upper,5}{
      \ifnum \y=1
      \node [every neuron/.try, fill=red!100!white, neuron \m/.try,
      ...
      scale=\upperscale] (ste-\m) at (3/\compress,\uppery-\y/\granupper) {};
      \else
      \node [every neuron/.try, neuron \m/.try, scale=\upperscale] (ste-\m)
      at (3/\compress,\uppery-\y/\granupper) {};
      \fi
      \fi
      \fi
    } 
...

  {
    ...
    {Regression \\ Layer \\[5pt] $\mathbb{R}^n$};
