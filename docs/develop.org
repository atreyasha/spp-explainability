...
***** make screen recordings of each chapter to fine-tune everything 
****** reduce words in slides so that they function as guides 
****** do one final run in one-go to ensure everything works
****** get feedback from live session
***** do spell-check of all slides
***** think again about adding more appendix slides for other counter points
