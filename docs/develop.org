...
***** Regex proxy
****** TODO SoPa++ simplification to regex proxy
******* add psuedocode to further show simplifcation process -> need to add functions to pseudocode
******* add conditionals to check if document is of sufficient length
******* mention compression process
...
****** describe meaning of SoPa++ and how it was improved
