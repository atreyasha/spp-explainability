...
**** Methodologies
***** SoPa++
****** add transition matrices, start and end vectors to spp -> use correct semiring notations
****** re-write algorithm as WFA-omega traversal algorithm -> adapt from sopa paper
