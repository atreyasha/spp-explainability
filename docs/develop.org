...
***** TODO Complete computational graph for the regex proxy model -> think of how to relate to SoPa++ if possible 
***** SoPa++
****** Lower model
...
******* show TikZ visualization of regex computational graph and try to add labels to segments if this makes explanations easier
