...
****** mention SoPa explainability techniques with cropped figures
***** Data set and methodologies (~6 slides)
****** FMTOD data set general information 
****** SoPa++ + talk about STE's directly here
****** Also how research questions were answered
***** Results (~3 slides)
***** Discussion (~3 slides)
***** Conclusions (~1 slide)
***** Future work (~2 slide)
