...
****** produce pretty and compact ensemble of regular expressions, use graphviz for this
****** think about how to work with unknown tokens on new data for mimic model
****** perform comparisons of quantification across various compression methods
