...
*** Current
**** Manuscript
***** TODO Set up all local writing tasks, extract tasks from notes below to here and tidy up all notes
****** compartmentalize certain tasks into further work section, and leave others to current
***** Thesis formatting
****** fill up title page and other basic information
****** remove red link color in table of contents, fix color of citation dates
****** attempt using two sided format but remove ghost pages if possible
****** add Uni-Potsdam declaration
