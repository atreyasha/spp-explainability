...
** Tasks
*** Current
**** Complete model improvements and run SoPa++ for grid runs
     DEADLINE: <2021-01-07 Thu>
***** TODO Modify final layer to a general additive layer
****** binarize scores by using a normalization technique for scores and then taking the relu + sign
****** remove mlp from source code and from argument parser as well
...
****** construct more complicated basis functions, such as polynomials if applicable; see: https://stackoverflow.com/questions/55920015/how-to-realize-a-polynomial-regression-in-pytorch-python
