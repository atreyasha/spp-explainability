...
*** Tasks
**** Slides
***** TODO Conclusions (~1 slide)
***** TODO Future work (~2 slides)
***** Do spell-check of all slides
     DEADLINE: <2021-07-04 Sun>

**** Do timed practice to hit 20 minutes
***** Complete animations of slides
****** consider using stepwise tikz rectangles for CGs
****** consider whether to use partial uncover or uncover all
****** consider using red rectangles to highlight certain areas of figures
***** 20 minute timed practice will help fine-tuning slides
***** Prepare extra slides which could help answer counter-questions in additional 30 minuts
****** bring up mistake on percentages in the defense
****** prepare counter opinions/slides on three guidelines for evaluation, usefulness, explainability survey and target audiences
