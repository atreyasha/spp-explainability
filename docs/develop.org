...
***** [#A] Model OOP
****** use matplotlib nested pie charts for importances (with subtypes from class serialization), pipe output using ~tikzplotlib~ and build to pdf using the shell script
***** [#A] Regex OOP
