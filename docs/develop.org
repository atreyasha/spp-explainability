...
*** Tasks
**** Slides
***** TODO Discussion (~3 slides)
****** check if we can find stronger inductive biases to discuss, such as pronouns or gender
****** we can also go into USA centric pronouns and digital formatting
***** Conclusions (~1 slide)
...
***** practice will help fine-tuning slides
***** prepare for counter-questions for additional 30 minutes
***** prepare extra slides which could help answer counter-questions
****** eg. comparison table of SoPa vs. SoPa++
****** perhaps information on target audiences and explainability evaluation
