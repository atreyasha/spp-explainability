...
** Tasks
*** Current
**** Add evaluation/prediction workflow with independent script and run grid-search(es) 
     DEADLINE: <2021-01-10 Sun>
***** Training workflow
****** TODO add some basic help scripts to fill up readme and increase morale
****** conduct single/grid normal/resume tests to ensure training procedures work smoothly before running
****** run grid-search with single random-seed first
