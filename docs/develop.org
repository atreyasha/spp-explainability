...
******* initial steps
******** TODO understand code in =soft_patterns.py= and add comments where necessary + fix long line flymake errors around + rename alphabetical variables to more semantic terms
