...
******* add typing to remaining core python scripts -> use this to gain an understanding
...
******* add tensorboard to explicit dependencies to view relevant logs during training
******* initial issues
