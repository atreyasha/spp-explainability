...
******* branch off and remove all boilerplate code and keep simplest SoPa variants -> convert all files which require torch
******* incoporate useful SOPs such as namespace saving and printing
******* improve code quality with model logging and tensorboard workflows
