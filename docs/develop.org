...
******* replace outdated torch code ->no need to declare variables with autograd explicitly: see https://stackoverflow.com/questions/57580202/whats-the-purpose-of-torch-autograd-variable
...
******** remove sample data when unnecessary and provide only description of data structures required
