...
******* replace all Variable calls with simple Tensors and add =requires_grad= argument directly to tensors where this is necessary: see https://stackoverflow.com/questions/57580202/whats-the-purpose-of-torch-autograd-variable
...
******* add typing to remaining core python scripts
...
******** investigate whether =fixed_var= function is indeed necessary or can be removed -> left intact for now
