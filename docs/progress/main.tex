...
\begin{frame}
  ...
  \begin{figure}				       
    ...
    \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=10cm]{./images/sample_fsa_sopa.png}
...
\begin{frame}
  ...
  \begin{figure}				       
    \captionsetup{justification=centering}
    \includegraphics[trim={0.5cm 0cm 0cm 0.5cm},clip,width=11cm]{./images/sopa_computational_graph.png}
