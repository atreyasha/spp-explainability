...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Facebook NLU multi-class intent detection data set from \citet{schuster-etal-2019-cross-lingual}
...
\begin{frame}
  ...
  \begin{figure}				       
    \captionsetup{justification=centering}
    \includegraphics[width=10cm]{pdfs/generated/sopa_upper_diagram/main.pdf}
...
\begin{frame}
  ...
  \begin{figure}				       
    \captionsetup{justification=centering}
    \includegraphics[width=9.5cm]{pdfs/generated/sopa_upper_diagram_explain/main.pdf}
...
\begin{frame}
  ...
  \end{table}
  \begin{itemize} 
    \item Performance is competitive with that from literature and online benchmarks, which show F$_1$ scores ranging from 96-99$\%$ \citep{schuster-etal-2019-cross-lingual}
