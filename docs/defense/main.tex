...
\begin{frame}
  ...
  \uncover<2>{Discussion: \setlength{\leftmargini}{0.5cm}
    \begin{itemize}
      \setlength\itemsep{1em}
      \item No standard for effective explanations by simplification
...
% TODO: we can also go into USA centric pronouns and digital formatting
% TODO: check if we can find stronger inductive biases to discuss, such as pronouns or gender
