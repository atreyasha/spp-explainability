% import packages
\documentclass[8pt,handout,table=xcolor,usenames,dvipsnames]{beamer}
...
\begin{frame}
  ...
  \uncover<4>{ Efficiency:
    \begin{itemize}
      ...
      \citep{wang2011gregex,zu2012gpu,yu2013gpui}
    \end{itemize}
  } 
\end{frame}
...
\begin{frame}{}
  \frametitle{\null}
  \centering \Huge \emph{Thank you for your time and attention
...
% LocalWords:  Upsampling Softmax accuracies FMTOD's softmax centric
