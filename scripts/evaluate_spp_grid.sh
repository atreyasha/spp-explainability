...
usage() {
  cat <<EOF
Usage: evaluate_spp_grid.sh [-h|--help] neural_model_checkpoint

Evaluate SoPa++ model(s) on an evaluation data set for a model grid
directory, which has the benefit of summarizing the best model
performance
